...
const Learn = () => {
  return (
    <div>
      ...
      <h2>Présentation et préparation</h2>
         <ul>
           ...
           <li>16 pièces différentes ayant chacune 4 caractères (fig. 1):
     ...
     <h2>But Du jeu</h2>
       <ul>
         <li>Créer sur le plateau un alignement de 4 pièces ayant au moins un caractère commun (fig.2).</li>
         <li>Cet alignement peut-être horizontal, vertical ou diagonal (fig. 3).</li>
       </ul>

    <h2>DEROULEMENT D’UNE PARTIE</h2>
    <ul>
      <li>Le premier joueur est tiré au sort.</li>
      <li>Il choisit une des 16 pièces et la donne à son adversaire (fig. 4).</li>
    ...
    <p>La partie est gagnée par le premier joueur qui annonce “QUARTO !” (fig 5). <br />
      1 Un joueur fait “QUARTO !” et gagne la partie lorsque, en plaçant la pièce donnée:</p>
    <ul>
    ...
    <div className='figures'>
      ...
      <figure>
        ...
        <figcaption>Figure 2 (sur ce exemple le caractère est la couleur)</figcaption>
      </figure>
